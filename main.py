...
my_img=ImageTk.PhotoImage(Image.open("C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\main.png"))
...
def checking():
    ...
    root.title("Checking")
    my_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\checking.png")
    k=Label(root,image=my_img).pack()
    logo=PhotoImage(file="C:\\Users\\Rgukt\Desktop\\Hotel Management System using python\\minimages\\LOGO.png")
    b1=Button(root,image=logo,bd=0,bg="#050a30",activebackground="#050a30",cursor="hand2",command=home).place(x=30,y=15)
    def fetch_datafeed():
        conn=pymysql.connect(host="localhost",user="root",password="Janu@1477",database='userdata')
...
def food():
    root=Toplevel()
    root.geometry('1366x768')
    root.title("Food page")
    my_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\foodpage.png")
    k=Label(root,image=my_img).pack()
    logo=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\LOGO.png")
    b1=Button(root,image=logo,bd=0,bg="#050a30",activebackground="#050a30",cursor="hand2",command=home).place(x=20,y=15) 
    root.mainloop()
def feedback():
    root=Toplevel()
    root.geometry('1366x768')
    root.title("Feedback")
    my_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\feedback.png")
    k=Label(root,image=my_img).pack()
    logo=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\LOGO.png")
    b1=Button(root,image=logo,bd=0,bg="#050a30",activebackground="#050a30",cursor="hand2",command=home).place(x=20,y=15)
    frame=Frame(root,width=700,height=460,bg='#fbf5e9')
    frame.place(x=630,y=149)
    img=ImageTk.PhotoImage(Image.open("C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\fedback.png"))
...
def checkout():
    ...
    my_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\checkout.png")
    k=Label(root,image=my_img).pack()
    logo=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\LOGO.png")
    b1=Button(root,image=logo,bd=0,bg="#050a30",activebackground="#050a30",cursor="hand2",command=home).place(x=20,y=15)
    img=ImageTk.PhotoImage(Image.open("C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\checko.png"))
...
def addroom():
    ...
    my_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\addrooms.png")
    k=Label(root,image=my_img).pack()
    logo=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\LOGO.png")
    b1=Button(root,image=logo,bd=0,bg="#050a30",activebackground="#050a30",cursor="hand2",command=home).place(x=20,y=15)
...
def roombooking():
    ...
    my_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\roombook.png")
    k=Label(root,image=my_img).pack()
    logo=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\LOGO.png")
    b1=Button(root,image=logo,bd=0,bg="#050a30",activebackground="#050a30",cursor="hand2",command=home).place(x=20,y=15)
...
def addcustomer():
    ...
    my_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\addcust.png")
    k=Label(root,image=my_img).pack()
    logo=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\LOGO.png")
    b1=Button(root,image=logo,bd=0,bg="#050a30",activebackground="#050a30",cursor="hand2",command=home).place(x=20,y=15)

    book=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\bookroom.png")
...
def services_page():
    ...
    my_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\ser.png")
    k=Label(ser,image=my_img).pack()

    book=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\book.png")
    b1=Button(ser,image=book,bd=0,bg="#00014C",activebackground="#00014C",cursor="hand2",command=addcustomer).place(x=300,y=315)

    checko=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\co.png")
    b2=Button(ser,image=checko,bd=0,bg="#00014C",activebackground="#00014C",cursor="hand2",command=checkout).place(x=280,y=415)


    feed=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\feed.png")
    b3=Button(ser,image=feed,bd=0,bg="#00014C",activebackground="#00014C",cursor="hand2",command=feedback).place(x=280,y=615)


    foo=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\food.png")
    b6=Button(ser,image=foo,bd=0,bg="#00014C",activebackground="#00014C",cursor="hand2",command=food).place(x=280,y=515)

    add=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\add.png")
    b4=Button(ser,image=add,bd=0,bg="#00014C",activebackground="#00014C",cursor="hand2",command=admin_add).place(x=865,y=380)


    check=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\check.png")
    b5=Button(ser,image=check,bd=0,bg="#00014C",activebackground="#00014C",cursor="hand2",command=admin_checking).place(x=860,y=510)
    ser.mainloop()
...
def aboutus_page():
    ...
    m_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\about.png")
...
def contactus_page():
    ...
    m_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\contact.png")
...
def home():
    ...
    def logoutpage():
        ...
        if res==1:
            ...
            signup=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\admin.png")
            eyebutto=Button(roo,image=signup,bd=0,bg="white",activebackground="white",cursor="hand2",command=admin_page)
            eyebutto.place(x=775,y=295)

            signin=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\user.png")
            eyebutto=Button(roo,image=signin,bd=0,bg="white",activebackground="white",cursor="hand2",command=signin_page)
            eyebutto.place(x=375,y=295)
            roo.mainloop()


    my_img=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\homefinal.png")
    k=Label(root,image=my_img).pack()

    home=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\HOMEC.png")
    b1=Button(root,image=home,bd=0,bg="white",activebackground="white",cursor="hand2",command=home).place(x=500,y=31)

    services=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\SERVICESC.png")
    b2=Button(root,image=services,bd=0,bg="white",activebackground="white",cursor="hand2",command=services_page).place(x=645,y=27)

    aboutus=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\ABOUTUSC.png")
    b3=Button(root,image=aboutus,bd=0,bg="white",activebackground="white",cursor="hand2",command=aboutus_page).place(x=810,y=15)

    logout=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\LOGOUTC.png")
    b4=Button(root,image=logout,bd=0,bg="white",activebackground="white",cursor="hand2",command=logoutpage).place(x=1180,y=23)


    contactus=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\CONTACTUSC.png")
...
def forgot_adminpage():
    ...
    bgimg=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\ho17.png")
    ...
    def login_page():
        if user.get()=='' or code.get()=='' or cu.get=='':
            ...
            try:
                con=pymysql.connect(host="localhost",user="root",password="Janu@1477")
                mycursor=con.cursor()
            except:
    ...
    def hide():
        openeye.config(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\eye2.png")
        u.config(show="*")
        eyebutton.config(command=show)
    def show():
        openeye.config(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\e1.png")
        u.config(show='')
        eyebutton.config(command=hide)


    def hid():
        openey.config(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\eye2.png")
        cu.config(show="*")
        eyebutto.config(command=sho)
    def sho():
        openey.config(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\e1.png")
        cu.config(show='')
    ...
    openeye=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\e1.png")
    ...
    openey=PhotoImage(file="C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\e1.png")
...
def signup_page():
    ...
    img=ImageTk.PhotoImage(Image.open("C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\ho1.jpg"))
...
def signin_page():
    ...
    img=ImageTk.PhotoImage(Image.open("C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\ho3.jpg"))
...
def admin_page():
    ...
    img=ImageTk.PhotoImage(Image.open("C:\\Users\\Rgukt\\Desktop\\Hotel Management System using python\\minimages\\manager.png"))
